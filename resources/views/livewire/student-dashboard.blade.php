                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-slate-800 mt-1">{{ $enrollments->count() }}/4</p>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-slate-800 mt-1">{{ $completedEnrollments->count() }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-slate-800 mt-1">
                                @if($completedEnrollments->count() > 0)
                                    {{ round(($completedEnrollments->where('grade', 'PASS')->count() / $completedEnrollments->count()) * 100) }}%
                                @else
                                    N/A
                                @endif
                            </p>
                            ...
                            <div class="border border-slate-200 rounded-xl p-5 bg-white hover:shadow-md transition">
                                <div class="flex items-center mb-3">
                                    <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                                        <span class="text-blue-600 font-bold">{{ substr($enrollment->module->module, 0, 1) }}</span>
                                    </div>
                                    <div class="flex-1">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-sm">Enroll in new modules ({{ 4 - $enrollments->count() }} slots available)</p>
                    </div>
                </div>
