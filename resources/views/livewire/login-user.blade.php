<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-800 py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-6">
        <!-- Compact Logo and Header -->
        <div class="text-center">
            <div class="flex justify-center items-center space-x-4 mb-4">
                <div class="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center shadow-xl">
                ...
                <div class="text-left">
                    ...
                    <p class="text-indigo-300 text-sm">Sign in to continue</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-6 border border-white/20">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" wire:model="email" 
                            class="block w-full pl-10 pr-4 py-2.5 bg-white/10 border border-white/20 rounded-xl text-white placeholder-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition duration-200" 
            ...
            <div class="mt-4 text-center">
                <p class="text-indigo-200 text-sm">
                    ...
                    <a href="{{ route('register') }}" class="font-semibold text-white hover:text-indigo-300 transition duration-200 underline underline-offset-2">
                        Create one now
                    </a>
                </p>
            </div>
