        ...
        <!--[if BLOCK]><![endif]--><?php if($userRole === 'old_student'): ?>
            ...
            <div class="bg-white rounded-xl md:rounded-2xl shadow-sm border border-slate-200 p-4 md:p-6">
                ...
                <?php else: ?>
                            ...
                            <div class="border border-slate-200 rounded-xl p-4 bg-white">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium text-slate-800 text-sm"><?php echo e($enrollment->module->module); ?></span>
                                    </div>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-bold <?php echo e($enrollment->grade === 'PASS' ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'); ?>">
                                        <?php echo e($enrollment->grade ?? 'N/A'); ?>

                                    </span>
                                </div>
                                <div class="grid grid-cols-2 gap-2 text-xs text-slate-600">
                                    <div><span class="font-medium">Enrolled:</span> <?php echo e($enrollment->enrolled_at ? $enrollment->enrolled_at->format('M d, Y') : 'N/A'); ?></div>
                                    <div><span class="font-medium">Completed:</span> <?php echo e($enrollment->completed_at ? $enrollment->completed_at->format('M d, Y') : 'N/A'); ?></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                    ...
                    <!-- Pagination -->
                    <div class="mt-4">
                        <?php echo e($completedEnrollments->links()); ?>
                ...
                <div class="bg-white rounded-xl md:rounded-2xl shadow-sm border border-slate-200 p-4 md:p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl md:text-3xl font-bold text-slate-800 mt-1"><?php echo e($enrollments->count()); ?>/4</p>
                        </div>
                ...
                <div class="bg-white rounded-xl md:rounded-2xl shadow-sm border border-slate-200 p-4 md:p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl md:text-3xl font-bold text-slate-800 mt-1"><?php echo e($completedEnrollments->total()); ?></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl md:text-3xl font-bold text-slate-800 mt-1">
                                <!--[if BLOCK]><![endif]--><?php if($completedEnrollments->total() > 0): ?>
                                    <?php echo e(round(($completedEnrollments->where('grade', 'PASS')->count() / max($completedEnrollments->total(), 1)) * 100)); ?>%
                                <?php else: ?>
                                    N/A
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </p>
                            ...
                            <div class="border border-slate-200 rounded-xl p-4 md:p-5 bg-white hover:shadow-md transition">
                                <div class="flex items-center mb-3">
                                    <div class="w-8 h-8 md:w-10 md:h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                                        <span class="text-blue-600 font-bold text-sm"><?php echo e(substr($enrollment->module->module, 0, 1)); ?></span>
                                    </div>
                                    <div class="flex-1">
            ...
            <div class="bg-white rounded-xl md:rounded-2xl shadow-sm border border-slate-200 p-4 md:p-6 mb-6">
                <div class="flex items-center mb-4 md:mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-xs md:text-sm">Enroll in new modules (<?php echo e(4 - $enrollments->count()); ?> slots available)</p>
                    </div>
                </div>
                ...
                <?php else: ?>
                            ...
                            <div class="border border-slate-200 rounded-xl p-4 bg-white">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium text-slate-800 text-sm"><?php echo e($module->module); ?></span>
                                    </div>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($spots > 5 ? 'bg-emerald-100 text-emerald-700' : ($spots > 0 ? 'bg-amber-100 text-amber-700' : 'bg-red-100 text-red-700')); ?>">
                                        <?php echo e($spots); ?>/10
                                    </span>
                                </div>
                                <!--[if BLOCK]><![endif]--><?php if($spots > 0): ?>
                                    <button wire:click="enroll(<?php echo e($module->id); ?>)" class="w-full inline-flex items-center justify-center px-4 py-2 rounded-lg text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700 transition">
                                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
                                        Enroll
                                    </button>
                                <?php else: ?>
                    ...
                    <!-- Pagination -->
                    <div class="mt-4">
                        <?php echo e($availableModules->links()); ?>
