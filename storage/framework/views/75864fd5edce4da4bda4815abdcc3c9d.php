            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($assignedModules->count()); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($assignedModules->sum(fn($m) => $m->enrollments()->where('status', 'enrolled')->count())); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($studentsInModule->count()); ?></p>
                    </div>
            ...
            <?php else: ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $assignedModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-slate-200 rounded-xl p-5 hover:shadow-md transition cursor-pointer <?php echo e($selectedModule == $module->id ? 'ring-2 ring-indigo-500 bg-indigo-50' : 'bg-white'); ?>" wire:click="$set('selectedModule', <?php echo e($module->id); ?>)">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center mb-2">
                                        <div class="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center mr-3">
                                            <span class="text-indigo-600 font-bold"><?php echo e(substr($module->module, 0, 1)); ?></span>
                                        </div>
                                        <h3 class="font-semibold text-slate-800"><?php echo e($module->module); ?></h3>
                                    </div>
